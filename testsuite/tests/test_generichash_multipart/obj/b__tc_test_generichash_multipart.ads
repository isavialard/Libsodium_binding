...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_generichash_multipart" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#85bcc725#;
   pragma Export (C, u00001, "test_generichash_multipartB");
   ...
   u00114 : constant Version_32 := 16#268512a1#;
   pragma Export (C, u00114, "libsodium_bindingS");
   u00115 : constant Version_32 := 16#c6219f79#;
   pragma Export (C, u00115, "libsodium_interfaceB");
   u00116 : constant Version_32 := 16#91da6298#;
   pragma Export (C, u00116, "libsodium_interfaceS");
   u00117 : constant Version_32 := 16#e31b7c4e#;
   ...
   --  ada.text_io%b
   --  libsodium_binding%s
   --  libsodium_interface%s
   --  libsodium_interface%b
   --  test_generichash_multipart%b
