...
procedure Test_Box_Shared_Key is
...
begin
   ...
   Crypto_Box_Easy_Afternm (C, M_Alice, N, Alice_Shared_Key);
   Crypto_Box_Open_Easy_Afternm (M_Bob, C, N, Bob_Shared_Key);
